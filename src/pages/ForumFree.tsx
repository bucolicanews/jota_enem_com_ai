...
import { Loader2, MessageSquare, Search, Pencil, Trash2, Send, ArrowLeft, Crown, PlusCircle } from 'lucide-react'; import { CreateTopicDialog } from '@/components/CreateTopicDialog';
...
const ForumFree = () => {
  ...
  // NOVO ESTADO para o diálogo de aviso
  const [isProRequiredDialogOpen, setIsProRequiredDialogOpen] = useState(false);
  ...
  // Função para abrir o diálogo de aviso
  const handleOpenProRequiredDialog = () => {
    setIsProRequiredDialogOpen(true);
  };
      ...
      {loadingTopicDetail ? (
        ...
        <>
              ...
              <div className="p-4 border-t bg-gray-50 flex-shrink-0">
                ...
                <div className='mt-5'>
                  <Button onClick={handleOpenProRequiredDialog} disabled={!newComment.trim()}><Send className="mr-2 h-4 w-4" /> Enviar</Button>
                </div>
              </div>
            </>
      )}
  ...
  return (
    <>
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex flex-col h-full">
            <div className="flex-shrink-0 p-4 border-b flex justify-between items-center gap-4 bg-white">
              ...
              {/* NOVO BOTÃO QUE ABRE O DIÁLOGO */}
              <Button onClick={handleOpenProRequiredDialog}>
                <PlusCircle className="mr-2 h-4 w-4" /> Criar Tópico
              </Button>
          </div>
      ...
      {/* NOVO Diálogo de aviso para usuários free */}
      <Dialog open={isProRequiredDialogOpen} onOpenChange={setIsProRequiredDialogOpen}>
        <DialogContent className="sm:max-w-md text-center">
          <DialogHeader className="items-center">
            ...
            <DialogTitle className="text-xl font-bold text-gray-900">
              Funcionalidade Exclusiva para Membros PRO!
            </DialogTitle>
            <DialogDescription className="text-sm text-gray-600 mt-2">
              Para criar novos tópicos, você precisa ter um plano PRO.
              Atualize seu plano agora e tenha acesso a todas as funcionalidades!
            </DialogDescription>
          </DialogHeader>
          <div className="flex justify-center mt-6 space-x-4">
            <Button variant="outline" onClick={() => setIsProRequiredDialogOpen(false)}>
              Voltar
            </Button>
            <Button onClick={() => {
              navigate('/pricing');
              setIsProRequiredDialogOpen(false);
            }}>
              Atualizar Plano
            </Button>
          </div>
